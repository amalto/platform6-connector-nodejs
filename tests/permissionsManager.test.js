...
test('Check the permissions: with an invalid instance', t => {
	t.throws(() => PermissionsManager.hasPermissions(null, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET2))
	t.throws(() => PermissionsManager.hasAnyPermissions(null, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET2))
})
...
test('Check the permissions: the user\'s permissions are null', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, null, Constants.PERMISSIONS_SET1), false)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, null, Constants.PERMISSIONS_SET1), false)
})

test('Check the permissions: the user has the required permission #1', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET2), true)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET2), true)
})

test('Check the permissions: the user has the required permission #2', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET1), true)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET1), true)
})

test('Check the permissions: the user does\'nt have at all the required permissions #1', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET8), false)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET8), true)
})

test('Check the permissions: the user does\'nt have all the required permissions #2', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET9), false)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET1, Constants.PERMISSIONS_SET9), true)
})

test('Check the permissions: the user has an admin permission for a service', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET4, Constants.PERMISSIONS_SET6), true)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET4, Constants.PERMISSIONS_SET6), true)
})

test('Check the permissions: the user is assigned on several instances and has the permissions', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_SUPER, Constants.INSTANCE_SET3, Constants.PERMISSIONS_SET6), true)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_SUPER, Constants.INSTANCE_SET3, Constants.PERMISSIONS_SET6), true)
})

test('Check the permissions: the user is assigned on several instances and has not the permissions', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_DEV, Constants.INSTANCE_SET2, Constants.PERMISSIONS_SET10), false)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_DEV, Constants.INSTANCE_SET2, Constants.PERMISSIONS_SET10), true)
})

test('Check the permissions: the user is assigned to several instances', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_DEV, Constants.INSTANCE_SET2, Constants.PERMISSIONS_SET6), true)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_DEV, Constants.INSTANCE_SET2, Constants.PERMISSIONS_SET6), true)
})

test('Check the permissions: the user is a super user on this instance', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET5, Constants.PERMISSIONS_SET8), true)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET5, Constants.PERMISSIONS_SET8), true)
})
...
test('Check the permissions: the user is a super user on the super instance', t => {
	t.is(PermissionsManager.hasPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET6, Constants.PERMISSIONS_SET5), true)
	t.is(PermissionsManager.hasAnyPermissions(Constants.INSTANCE_ROXANE, Constants.INSTANCE_SET6, Constants.PERMISSIONS_SET5), true)
})
